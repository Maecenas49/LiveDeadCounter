...
public class AppRater extends DialogFragment{
    private final static String APP_TITLE = "Live/Dead Cell Counter";// App Name
    private final static String APP_PNAME = "com.computing.millenium.springers.livedeadcounter";// Package Name
    ...
    public static void app_launched(Context mContext) {
        ...
        Log.d(TAG, "Launch Count: " + String.valueOf(launch_count));
